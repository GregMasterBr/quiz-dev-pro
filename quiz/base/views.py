        ...
        try:
            ...
            if requisicao.method == 'POST':
                ...
                if resposta_indice == pergunta.alternativa_correta:
                    ...
                    try:
                        data_da_primeira_reposta = Resposta.objects.filter(pergunta=pergunta).order_by('respondida_em')[
                            0].respondida_em
                    except IndexError:
                        ...
                        diferenca = now() - data_da_primeira_reposta
                        diferencao_em_segundos = int(diferenca.total_seconds())
                        pontos = max(PONTUACAO_MAXIMA - diferencao_em_segundos, 10)
